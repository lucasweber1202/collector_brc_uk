"""Create the collector_brc_uk schema and its five standardized tables.
...
#    publisher: BRC is the economic publisher, and the data reaches us through a
...
#    `original_publisher` therefore always names BRC, while
...
# lets a stored observation be traced back to "BRC, delivered by Bloomberg,
