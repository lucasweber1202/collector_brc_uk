"""Runtime settings for collector_brc_uk.
...
SOURCE_ID = "brc_shop_price_monitor"
ORIGINAL_PUBLISHER = "British Retail Consortium"
PUBLISHER_URL = "https://brc.org.uk/market-intelligence/publications/monitors/shop-price-monitor/"
...
CROSS_CHECK_TOLERANCE = float(os.getenv("CROSS_CHECK_TOLERANCE", "0.05"))
